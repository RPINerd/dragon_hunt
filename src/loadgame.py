...
def load_selected():
    ...
    g.create_norm_box(
        ...
        (g.tilesize * g.main.mapsizex / 2, 140 + g.buttons["load_scr.png"].get_height()),
    )
    g.print_string(
        g.screen,
        ...
        (
            ...
            g.tilesize * g.main.mapsizey / 3 + 70 + g.buttons["load_scr.png"].get_height() / 2,
        ),
    )
    pygame.display.flip()
...
def display_stats(stat_dict, titles_dict):
    ...
    g.screen.fill(
        g.colors["light_gray"],
        (
            g.tilesize * g.main.mapsizex / 4 + g.buttons["loadgame_up.png"].get_width() + 3,
    ...
    for i in range(5):
        ...
        g.print_string(
            ...
            (
                ...
                g.tilesize * g.main.mapsizey / 3 + g.buttons["loadgame_down.png"].get_height() + 2 + i * 20,
            ),
        )
...
def mouse_handler_move(xy):
    ...
    if mouse_over(
        ...
        g.tilesize * g.main.mapsizex / 4 + g.buttons["load_scr.png"].get_width(),
        g.tilesize * g.main.mapsizey / 3 + 140,
        g.tilesize * g.main.mapsizex / 4 + g.buttons["load_scr.png"].get_width() + g.buttons["leave.png"].get_width(),
...
def refresh_buttons():
    ...
    g.screen.blit(g.buttons[load_img], (g.tilesize * g.main.mapsizex / 4, g.tilesize * g.main.mapsizey / 3 + 140))
    g.screen.blit(
        g.buttons[leave_img],
        (
            g.tilesize * g.main.mapsizex / 4 + g.buttons["load_scr.png"].get_width(),
    ...
    g.screen.blit(g.buttons[up_img], (g.tilesize * g.main.mapsizex / 4, g.tilesize * g.main.mapsizey / 3))
    g.screen.blit(
        g.buttons[down_img],
        (
            g.tilesize * g.main.mapsizex / 4,
...
def init_window_loadgame():
    ...
    g.create_norm_box(
        ...
        (g.tilesize * g.main.mapsizex / 2 + 2, +140 + g.buttons["load_scr.png"].get_height() + 2),
    )
    ...
    g.screen.blit(g.buttons["loadgame_up.png"], (g.tilesize * g.main.mapsizex / 4, g.tilesize * g.main.mapsizey / 3))
    g.screen.blit(
